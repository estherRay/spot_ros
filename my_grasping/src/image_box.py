...
"""Get an image from the frontright camera of Spot. User inputs a pixel on the object to be picked up.
    The pixel information is sent as PixelPose msg to spot_ros, then spot_wrapper to command Spot to walk up to the selected object in the image."""
...
class image_display():
  ...
  def main(self):
    ...
    # The pixel sent are rotated by 90 degrees!!
