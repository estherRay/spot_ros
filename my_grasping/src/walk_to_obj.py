...
"""Get an image from the frontright camera of Spot. User inputs a bounding box around the object to be picked up.
    The bounding box information is sent as PixelList to spot_ros, then spot_wrapper to command Spot to walk up to the selected object in the image."""
...
class image_display():
  ...
  def main(self):
    ...
    self.location_publisher = rospy.Publisher('object_box', PixelList, queue_size=10)
