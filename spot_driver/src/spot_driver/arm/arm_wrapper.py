...
from spot_driver.arm.arm_utilities.fetch import fetch_main
...
class ArmWrapper:
    def __init__(self, robot, wrapper, logger):
        ...
        self.my_fetch_try = rospy.Service("my_fetch_try", Trigger, self.handle_my_fetch_try)
    ...
    def handle_my_fetch_try(self, srv_data):
        rospy.loginfo("Fetch starting")
        resp = fetch_main(self._robot, self._spot_wrapper)
